      ...
      <div className="absolute top-0 left-0 right-0 z-20 border-b border-white/20">
        <div className="container mx-auto px-4 lg:px-8 py-3 lg:py-4 flex items-center justify-between">
          <div className="flex items-center gap-2 lg:gap-4">
            ...
            <span className="text-white/60 text-[8px] lg:text-[10px] font-mono">STARTUP FUNDRAISING</span>
          </div>
          ...
          <div className="max-w-lg relative lg:ml-auto">
            ...
            <div className="relative">
              <p className="text-xs lg:text-base text-gray-300 mb-5 lg:mb-6 leading-relaxed font-mono opacity-80">
                Navigate Regulation CF and Regulation A+ with confidence. Our platform guides startups through every step of SEC-compliant fundraising—from Form ID to closing.
              </p>
            ...
            <div className="hidden lg:flex items-center gap-2 mt-6 opacity-40">
              ...
              <div className="flex-1 h-px bg-white"></div>
              <span className="text-white text-[9px] font-mono">SEC.COMPLIANT</span>
            </div>
          </div>
        </div>
      </div>
